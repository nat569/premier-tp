...
return $this->services['App\Repository\FormationRepository'] = new \App\Repository\FormationRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
