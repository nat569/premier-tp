...
})))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel', 1)) && false ?: '_'}, ($this->targetDirs[3].'/src'), array(($this->targetDirs[3].'/vendor/symfony/twig-bridge/Resources/views/Form') => NULL), ($this->targetDirs[3].'/templates')));
