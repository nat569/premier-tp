...
return $this->services['App\Repository\ExperienceRepository'] = new \App\Repository\ExperienceRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
