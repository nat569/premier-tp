...
return $this->services['App\Repository\ContactRepository'] = new \App\Repository\ContactRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
