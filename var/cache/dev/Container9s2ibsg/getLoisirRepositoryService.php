...
// Returns the private 'App\Repository\LoisirRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LoisirRepository.php';

return $this->services['App\Repository\LoisirRepository'] = new \App\Repository\LoisirRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
