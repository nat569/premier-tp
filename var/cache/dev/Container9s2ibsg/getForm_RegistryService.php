...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\ContactType' => function () {
    return ${($_ = isset($this->services['App\Form\ContactType']) ? $this->services['App\Form\ContactType'] : ($this->services['App\Form\ContactType'] = new \App\Form\ContactType())) && false ?: '_'};
}, 'App\\Form\\ExperienceType' => function () {
    return ${($_ = isset($this->services['App\Form\ExperienceType']) ? $this->services['App\Form\ExperienceType'] : ($this->services['App\Form\ExperienceType'] = new \App\Form\ExperienceType())) && false ?: '_'};
}, 'App\\Form\\FormationType' => function () {
    return ${($_ = isset($this->services['App\Form\FormationType']) ? $this->services['App\Form\FormationType'] : ($this->services['App\Form\FormationType'] = new \App\Form\FormationType())) && false ?: '_'};
}, 'App\\Form\\LoisirType' => function () {
    return ${($_ = isset($this->services['App\Form\LoisirType']) ? $this->services['App\Form\LoisirType'] : ($this->services['App\Form\LoisirType'] = new \App\Form\LoisirType())) && false ?: '_'};
